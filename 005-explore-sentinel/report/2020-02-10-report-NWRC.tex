...
\chead[]{{\Large\bf Wetland Classification via Satellite Radar Data} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{z-S1-IW-VH}
\input{z-S1-IW-VV}
\input{z-S1-IW-V-opc1}
\input{z-S1-IW-V-opc2}

\input{z-S1-IW-VH-scaled}
\input{z-S1-IW-VV-scaled}
\input{z-S1-IW-V-opc1-scaled}
\input{z-S1-IW-V-opc2-scaled}
