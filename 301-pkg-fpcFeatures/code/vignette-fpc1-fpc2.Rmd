...
**fpcFeatureEngine** ignores all columns of the input time series data frame
that are irrelevant to the functional principal component computations
(but it does NOT reject input data frames with extra columns).
