...
\lhead[Kenneth Chu]{Progress Report (Draft)}
\chead[]{{\Large\bf Wetland Classification via Radar Satellite Data} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{z-S1-IW4-FPCA-scatter}
\input{z-S1-IW106-FPCA-scatter}

\input{z-S1-IW4-timeseries-FPCA}
\input{z-S1-IW106-timeseries-FPCA}

\input{z-S1-IW4-timeseries}
\input{z-S1-IW106-timeseries}
